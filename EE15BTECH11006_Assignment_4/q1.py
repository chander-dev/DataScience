...
# new predicted values according to the model
...
print('Linear is the best fit for the data as it has maximum chi square likelihood')
...
#log likelihood for all three models
...
# so accordig the the calculated AIC and BIC linear is better, then preferred model is quadratic and then cubic is least preferred
# print("********AIC********")
...
print('As the AIC/BIC of the linear is the least so it is the best model')
print('Larger is the delta AIC/BIC, the weaker would be the model so quadratic is preferred over cubic')
